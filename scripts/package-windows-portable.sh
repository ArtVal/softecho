...
Если Windows пишет «неизвестный издатель» / SmartScreen:
1. Нажмите «Подробнее»
2. Затем «Выполнить в любом случае»
Или: правый щелчок по softecho.exe → Свойства → галка «Разблокировать» → ОК.
Это обычное предупреждение для программ с GitHub, не вирус.
